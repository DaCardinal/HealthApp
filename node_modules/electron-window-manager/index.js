    ...
    Window.prototype.loadURL = function(url, options){
        ...
        if(layout && layoutFile && url.substring(0, 4) != 'http'){
            ...
            layoutUrl = layoutUrl.replace('file://', '');
            ...
            FileSystem.readFile(layoutFile, 'utf-8', function(error, layoutCode){
                ...
                FileSystem.readFile(url, 'utf-8', function(error, content){
                    ...
                    // Compile content & get the final body
                    var ctemplate = Handlebars.compile(content);
                    var template = Handlebars.compile(layoutCode);
                    var html = template({
                      "content": new Handlebars.SafeString(ctemplate({
                        "appBase": Application.getAppPath(),
                        "assets": utils.getAppAssetsPath()
                      })),
                      "appBase": Application.getAppPath(),
                      "assets": utils.getAppAssetsPath()
                    });
    ...
    var utils = {
        ...
        /**
         * Returns the full path to the application assets directory
         * */
        'getAppAssetsPath': function(){
            return Application.getAppPath() + '/assets';
        },
    ...
    var windowManager = {
        ...
        'config': {
            ...
            'assets': null, // The full path to the assets directory
            'pageTabGroup': null, //An instance of the TabGroupHandler
        ...
        'init': function(config){
            ...
            // If the asset url isn't provided
            if(!this.config.assets){
                this.config.assets = utils.getAppAssetsPath();
            }

            // If the TabGroupHandler isn't provided
            if(!this.config.pageTabGroup){
                this.config.pageTabGroup = null;
            }
